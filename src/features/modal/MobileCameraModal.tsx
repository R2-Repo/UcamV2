...
export function MobileCameraModal({
  ...
  return (
    <div className="app-modal-backdrop" role="presentation" onClick={onClose}>
      <div
        className="app-modal-dialog modal-dialog modal-dialog-centered modal-lg"
        role="dialog"
        aria-modal="true"
        aria-label={controller.displayedCamera.location}
      >
        <div
          className="modal-content glass-modal app-modal-shell app-react-modal app-react-modal--mobile"
          role="presentation"
          onClick={(event) => event.stopPropagation()}
        >
          <div className="modal-header modal-header-tight app-modal-topbar app-modal-topbar--mobile">
            <h5 className="modal-title">{controller.displayedCamera.location}</h5>
            <button
              className="button app-modal-close"
              type="button"
          ...
          <div className="modal-body modal-body-flex app-mobile-modal-body" id="modalBody">
            <CameraInfoDeck
              className="app-mobile-info-stack"
            ...
            <div
              className="mobile-carousel-scene app-mobile-carousel-scene"
              ...
              <div className="mobile-gallery" role="list">
                {controller.mobileCarouselEntries.map((entry) => {
                  ...
                  return (
                    ...
                    >
                      <img src={entry.imageUrl} alt={`Camera at ${entry.camera.location}`} loading="lazy" />
                    </button>
                  )
                })}
              </div>
            ...
            <div className="app-mobile-modal-meta">{controller.footerMeta}</div>

            <div className="app-mobile-carousel-nav">
              <button
            ...
            <div className="app-mobile-modal-actions">
