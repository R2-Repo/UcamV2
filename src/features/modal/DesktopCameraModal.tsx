...
import modalLogoAsset from '../../assets/gifLogo.gif'
...
export function DesktopCameraModal({
  ...
  return (
    <div className="app-modal-backdrop" role="presentation" onClick={onClose}>
      ...
      >
        <div
          className="modal-content glass-modal app-modal-shell app-react-modal app-react-modal--desktop"
          role="presentation"
          onClick={(event) => event.stopPropagation()}
        >
          <div className="modal-header modal-header-tight app-modal-topbar">
