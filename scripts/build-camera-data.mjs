...
const sourceDataRoot = path.resolve(appRoot, 'data-source')
const sourceGeoJsonPath = path.resolve(sourceDataRoot, 'cctv_locations_processed_classified.geojson')
const sourceRoutesPath = path.resolve(sourceDataRoot, 'routes.json')
const outputDir = path.resolve(appRoot, 'public', 'data')
